...
function Skills(props) {
    return (
        <div id="portfolio" className={`w-full rounded-[15px] bg-[#1C1E20FF] px-4 py-6 lg:px-10 lg:py-12 space-y-4`}>
            ...
            <div className={`cursor-default w-full pt-8 pl-10 lg:pl-4 flex flex-wrap flex-auto gap-y-12 gap-x-14`}>
                ...
                <h2 className={`${KanitFont.variable} font-[kanit] font-semibold uppercase relative tracking-wider text-base lg:text-xl text-white/80 hover:text-white`}>
                    Machine Learning
                    <BrainCircuit className="absolute top-[-1rem] left-[-2rem] opacity-20" />
                </h2>
                <h2 className={`${KanitFont.variable} font-[kanit] font-semibold uppercase relative tracking-wider text-base lg:text-xl text-white/80 hover:text-white`}>
                    Data Science
                    <ChartBar className="absolute top-[-1rem] left-[-2rem] opacity-20" />
                </h2>
                <h2 className={`${KanitFont.variable} font-[kanit] font-semibold uppercase relative tracking-wider text-base lg:text-xl text-white/80 hover:text-white`}>
                    React.js
